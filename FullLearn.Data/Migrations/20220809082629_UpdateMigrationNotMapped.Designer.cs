...
namespace FullLearn.Data.Migrations
{
    ...
    [Migration("20220809082629_UpdateMigrationNotMapped")]
    partial class UpdateMigrationNotMapped
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FullLearn.Data.Entities.Course.Course", b =>
                {
            ...
            modelBuilder.Entity("FullLearn.Data.Entities.Course.CourseEpisode", b =>
                {
            ...
            modelBuilder.Entity("FullLearn.Data.Entities.Course.CourseLevel", b =>
                {
                    b.Property<int>("LevelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FullLearn.Data.Entities.Course.CourseStatus", b =>
                {
                    b.Property<int>("StatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FullLearn.Data.Entities.Course.Course", b =>
                {
                    b.HasOne("FullLearn.Data.Entities.Course.CourseGroup", "CourseGroup")
                        .WithMany()
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FullLearn.Data.Entities.Course.CourseLevel", "CourseLevel")
                        .WithMany("Courses")
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FullLearn.Data.Entities.Course.CourseStatus", "CourseStatus")
                        .WithMany("Courses")
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FullLearn.Data.Entities.Course.CourseGroup", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("FullLearn.Data.Entities.Course.CourseEpisode", b =>
                {
                    b.HasOne("FullLearn.Data.Entities.Course.Course", "Course")
